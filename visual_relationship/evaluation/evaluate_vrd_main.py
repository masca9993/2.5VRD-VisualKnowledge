...
_DEFAULT_VRD_PATH = 'testdata/across_images_vrd.csv'
_DEFAULT_OBJECT_PATH = 'testdata/across_images_objects.csv'
#_DEFAULT_PREDICTION_PATH = 'testdata/across_images_prediction.csv'
_DEFAULT_OUTPUT_PATH = 'results/outputs.csv'
...
_OUTPUT_PATH = flags.DEFINE_string('output_path', _DEFAULT_OUTPUT_PATH,
